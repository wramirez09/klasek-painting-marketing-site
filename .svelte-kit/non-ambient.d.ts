...
declare module "$app/types" {
	export interface AppTypes {
		...
		LayoutParams(): {
			...
			"/(light-nav)/blog/[title]": { title: string };
			"/(light-nav)/careers": Record<string, never>;
			"/(light-nav)/careers/apply": Record<string, never>;
			...
			"/(light-nav)/services/siding-painting-repair/hardie-board-services": Record<string, never>;
