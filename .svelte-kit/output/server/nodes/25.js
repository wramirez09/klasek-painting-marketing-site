import * as universal from '../entries/pages/(dark-nav)/photo-gallery/brick-painting/_page.ts.js';

export const index = 25;
let component_cache;
export const component = async () => component_cache ??= (await import('../entries/pages/(dark-nav)/photo-gallery/brick-painting/_page.svelte.js')).default;
export { universal };
export const universal_id = "src/routes/(dark-nav)/photo-gallery/brick-painting/+page.ts";
