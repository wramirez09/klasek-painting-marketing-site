import * as universal from '../entries/pages/(light-nav)/services/siding-painting-repair/hardie-board-installation/_page.ts.js';

export const index = 60;
let component_cache;
export const component = async () => component_cache ??= (await import('../entries/pages/(light-nav)/services/siding-painting-repair/hardie-board-installation/_page.svelte.js')).default;
export { universal };
export const universal_id = "src/routes/(light-nav)/services/siding-painting-repair/hardie-board-installation/+page.ts";
