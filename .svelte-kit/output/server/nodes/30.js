import * as universal from '../entries/pages/(dark-nav)/photo-gallery/past-projects/_page.ts.js';

export const index = 30;
let component_cache;
export const component = async () => component_cache ??= (await import('../entries/pages/(dark-nav)/photo-gallery/past-projects/_page.svelte.js')).default;
export { universal };
export const universal_id = "src/routes/(dark-nav)/photo-gallery/past-projects/+page.ts";
