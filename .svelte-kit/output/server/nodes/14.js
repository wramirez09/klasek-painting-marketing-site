import * as universal from '../entries/pages/(dark-nav)/about-us/service-area/(city-pages)/la-grange-house-painting/_page.ts.js';

export const index = 14;
let component_cache;
export const component = async () => component_cache ??= (await import('../entries/pages/(dark-nav)/about-us/service-area/(city-pages)/la-grange-house-painting/_page.svelte.js')).default;
export { universal };
export const universal_id = "src/routes/(dark-nav)/about-us/service-area/(city-pages)/la-grange-house-painting/+page.ts";
