import * as universal from '../entries/pages/(light-nav)/services/stucco-painting-repair/stucco-painting/_page.ts.js';

export const index = 66;
let component_cache;
export const component = async () => component_cache ??= (await import('../entries/pages/(light-nav)/services/stucco-painting-repair/stucco-painting/_page.svelte.js')).default;
export { universal };
export const universal_id = "src/routes/(light-nav)/services/stucco-painting-repair/stucco-painting/+page.ts";
...
export const stylesheets = ["_app/immutable/assets/EmailSignup.CZe4dQ9e.css","_app/immutable/assets/ColumnTemplateSection.BAHm8oHF.css"];
export const fonts = [];
