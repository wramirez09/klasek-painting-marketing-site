import * as universal from '../entries/pages/(dark-nav)/photo-gallery/white-cedar-siding/_page.ts.js';

export const index = 39;
let component_cache;
export const component = async () => component_cache ??= (await import('../entries/pages/(dark-nav)/photo-gallery/white-cedar-siding/_page.svelte.js')).default;
export { universal };
export const universal_id = "src/routes/(dark-nav)/photo-gallery/white-cedar-siding/+page.ts";
