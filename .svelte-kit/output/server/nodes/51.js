import * as universal from '../entries/pages/(light-nav)/services/design-color-consultation/_page.ts.js';

export const index = 51;
let component_cache;
export const component = async () => component_cache ??= (await import('../entries/pages/(light-nav)/services/design-color-consultation/_page.svelte.js')).default;
export { universal };
export const universal_id = "src/routes/(light-nav)/services/design-color-consultation/+page.ts";
