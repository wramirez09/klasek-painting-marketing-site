...
let component_cache;
export const component = async () => component_cache ??= (await import('../entries/pages/(light-nav)/_layout.svelte.js')).default;
...
export const stylesheets = ["_app/immutable/assets/NavBar.DBFUqa5S.css","_app/immutable/assets/EmailSignup.CZe4dQ9e.css"];
export const fonts = [];
