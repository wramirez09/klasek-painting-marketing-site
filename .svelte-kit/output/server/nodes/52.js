import * as universal from '../entries/pages/(light-nav)/services/exterior-home-painting/exterior-paint-contractor/_page.ts.js';

export const index = 52;
let component_cache;
export const component = async () => component_cache ??= (await import('../entries/pages/(light-nav)/services/exterior-home-painting/exterior-paint-contractor/_page.svelte.js')).default;
export { universal };
export const universal_id = "src/routes/(light-nav)/services/exterior-home-painting/exterior-paint-contractor/+page.ts";
