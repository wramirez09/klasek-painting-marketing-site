import * as universal from '../entries/pages/(light-nav)/services/siding-painting-repair/cedar-siding-painting/_page.ts.js';

export const index = 58;
let component_cache;
export const component = async () => component_cache ??= (await import('../entries/pages/(light-nav)/services/siding-painting-repair/cedar-siding-painting/_page.svelte.js')).default;
export { universal };
export const universal_id = "src/routes/(light-nav)/services/siding-painting-repair/cedar-siding-painting/+page.ts";
