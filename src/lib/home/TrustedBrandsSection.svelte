...
<section class="md:pb-0 p-b md:px-12 bg-white">
	<div class="container max-w-screen-lg relative md:-top-12 flex flex-col items-center gap-2">
		<RibbonWrapper class="z-10 md:!w-fit !w-full after:md:block before:md:block">
			<h2
